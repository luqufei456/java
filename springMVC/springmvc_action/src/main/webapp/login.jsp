...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/login.action" method=post>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px">
                	<INPUT id=txtPwd style="WIDTH: 130px"  type=password name="password"></TD>
