...
<BODY>
<FORM id=form1 name=form1 action="${ pageContext.request.contextPath}/admin/add.action" method=post>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150>
                	<script type="text/javascript">
                		$(function() {
                			$("#txtName[name='user_code']").blur(function() {
                				$.ajax({
                ...
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  id="aaaaa" 
                  style="FONT-WEIGHT: bold; ; COLOR: black">请输入登录名</SPAN></TD></TR>
              <TR>
