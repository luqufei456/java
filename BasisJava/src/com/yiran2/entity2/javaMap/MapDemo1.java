 ...
 *
 * 最常用的Map集合是HashMap:键是唯一的且无序,这里的无序只是相对于一般理解，底层还是有一定排序规则的
 *   HashMap安全性要求较低，允许键、值为空 null     HashTable不行
 *
 *  用法:
 ...
 *
 *
 *      在遍历Map时，依然不能进行增加或删除操作，这是因为其set集合是依靠Map生成的，Entry同理，
 *  但是可以进行修改操作，即添加键相同，值不相同的键值对
 * */
