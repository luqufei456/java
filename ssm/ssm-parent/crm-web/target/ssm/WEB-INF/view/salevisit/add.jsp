					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<td>业务员姓名 ：</td>
								<td>
									<input name="user.user_id" type="hidden" style="WIDTH: 180px" value="<s:property value='#session.existUser.user_id'/>">
									<input name="user.userName" style="WIDTH: 180px" value="<s:property value='#session.existUser.user_name'/>" readonly="readonly">
								</td>
							</TR>
							...
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<s:textarea rows="3" cols="10" cssClass="textbox" cssStyle="width:180px;height:40px;" name="visit_detail"/>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
