			...
			<TD vAlign=top width=180 bgColor=#ffffff>
				<TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
					...
					<TR>
						<TD>
							<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
								...
								<TBODY>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/href/customer/add.action"
														   target=main>－ 新增客户</A></TD>
								</TR>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer/list.action"
					...
					<TR>
						<TD>
							<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
								...
								<TBODY>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/linkman/add.action"
					...
					<c:forEach var="role" items="${user.roles}">
						<c:if test="${role.roleName == '经理'  or role.roleName == '老板'}">
							<TR>
							...
							<TR>
								<TD>
									<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
										...
										<TR>
											<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/href/user/add.action"
