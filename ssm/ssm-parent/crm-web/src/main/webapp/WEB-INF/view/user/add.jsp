...
<BODY>
<FORM id=form1 name=form1 action="${ pageContext.request.contextPath}/user/add.action" method=post>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150>
                	<script type="text/javascript">
                		$(function() {
                			$("#txtName[name='user.userCode']").blur(function() {
                				$.ajax({
                					url:"${ pageContext.request.contextPath }/admin/ckn.action",
                					data:{"userCode":$(this).val()},
                					success:function(data) {
                						$("#aaaaa").css("VISIBILITY", "show");
                						if(data == "true") {
                							$("#aaaaa").html("可使用账号");
                						}else{
                							$("#aaaaa").html("已有账号");
                			...
                			//ajax获取角色名称 - 并显示
               				$.ajax({
               					url:"${pageContext.request.contextPath }/role/roles.action",
               					data:{},
               					success:function(data) {
               						$(data).each(function(index, obj) {
               							$("#userRole").append("<input type='checkbox' name='roleIds' value="+obj.roleId+">"+obj.roleName)
               						})
               					}
               				})
                		})
                	</script>
                	<INPUT id=txtName style="WIDTH: 130px" name="user.userCode"></TD>
                <TD style="HEIGHT: 28px" width=370><SPAN 
                  id="aaaaa" 
                  style="FONT-WEIGHT: bold; ; COLOR: white">请输入登录名</SPAN></TD></TR>
              <TR>
                <TD style="HEIGHT: 28px">登录密码：</TD>
                <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" 
                  type=password name="user.userPassword"></TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
                  style="WIDTH: 130px" name="user.userName"></TD>
                <TD style="HEIGHT: 28px" width=370><SPAN 
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" id="userRole" colspan="2">
